...
export default class Listings extends Component {
  ...
  renderListings() {
    const {
      listings, showAddToFav, handleAddToFav, favouriteListings, handleDealClick,
    } = this.props;
          ...
          <View>
            ...
            {!I18nManager.isRTL &&
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={styles.listingPrice}>
                  {translate('JD')}{listing.new_price}
                </Text>

                <View style={styles.location}>
                  <Icon name="ios-pin" style={styles.iconlocation} />
                  <Text numberOfLines={1} style={[styles.iconlocationText]}>{listing.company_branch.city.name.trim()}</Text>
                </View>
              </View>
            }
            ...
            {I18nManager.isRTL &&
              <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={styles.listingPrice}>
                  {listing.new_price}{translate('JD')}
                </Text>
      ...
      <View style={styles.wrapper}>
        ...
        >
          ...
          {listings.length <= 0 &&
            ...
            <View style={{
              justifyContent: 'center', alignContent: 'center', alignItems: "center", width: Dimensions.get('window').width - 30, borderRadius: 10, overflow: 'hidden',
              backgroundColor: theme.colors.white,
              elevation: 1
            }}>
              <Image resizeMode='contain' source={require('app/assets/nodata.png')} style={styles.imageNoData} />
            </View>
...
const styles = StyleSheet.create({
  ...
  textOff: {
    ...
    fontSize: 12,
    padding: 5,
    ...I18nManager.isRTL ? { transform: [{ rotate: '-310deg' }] } : { transform: [{ rotate: '-40deg' }] },
  },
  separatorContainer: {
    alignItems: 'center',
    flexDirection: 'row',
  ...
  triangleCorner: {
    width: 0, height: 0, backgroundColor: 'transparent', position: 'absolute',
    zIndex: 0, borderStyle: 'solid', borderRightWidth: 60, borderTopWidth: 60, borderRightColor: 'transparent', borderTopColor: theme.colors.primary
  },
  imageNoData: {
    width: '100%',
    height: 200,
