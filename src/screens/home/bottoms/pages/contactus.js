            ...
            <View style={styles.container_scrolling}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={styles.wrapper} contentContainerStyle={{ paddingBottom: moderateScale(100) }}>
                    ...
                    <View style={{ marginTop: moderateScale(20), flexDirection: 'column' }}>
                        ...
                        <View style={{ marginHorizontal: moderateScale(22), marginVertical: moderateScale(0), zIndex: 1, marginTop: moderateScale(10) }}>
                            <View showsVerticalScrollIndicator={false} style={{ marginHorizontal: moderateScale(20), paddingVertical: moderateScale(10) }}>

                                <Text style={{ color: theme.colors.secondary, marginBottom: moderateScale(10), ...I18nManager.isRTL ? { textAlign: 'left' } : {}, marginHorizontal: moderateScale(20) }}>{translate('Name')}</Text>
                                <TextInput
                                ...
                                />
                                <Text style={{ color: theme.colors.secondary, marginBottom: moderateScale(10), ...I18nManager.isRTL ? { textAlign: 'left' } : {}, marginHorizontal: moderateScale(20) }}>{translate('Email')}</Text>
                                <TextInput
                                    style={[styles.input, { ...I18nManager.isRTL ? { textAlign: 'right' } : {}, paddingHorizontal: moderateScale(10) }]}
                                ...
                                <Button isLoading={this.state.submitReview} style={styles.checkout} textStyle={{ fontSize: 16, color: theme.colors.primary, fontSize: moderateScale(20), fontWeight: 'bold' }}
                                    onPress={() => {
                                        this.contactus();
                        ...
                        <View style={{
                            ...
                            height: moderateScale(320), paddingTop: moderateScale(0), alignItems: 'center',
                        }}>
                            ...
                            <TouchableOpacity onPress={() => {
                                ...
                                <Text style={{ paddingHorizontal: moderateScale(50), textAlign: 'center', color: theme.colors.secondary, fontSize: moderateScale(15) }}>{'15 wesrt Ground Floor, Burjuman Dubai · In BurJuman'}</Text>
                            </TouchableOpacity>

                            <View style={{ width: '20%', backgroundColor: theme.colors.secondary, height: 1, marginVertical: moderateScale(20) }} />

                            <TouchableOpacity style={{ flexDirection: 'row' }} onPress={() => {
                                Linking.openURL(`tel:${'+0971528132016'}`)
                            }}>
                                <Image source={require('app/assets/phone.png')} resizeMode="contain" style={{ height: moderateScale(20), width: moderateScale(20), }} />
                                <Text style={{ textAlign: 'center', color: theme.colors.secondary, fontSize: moderateScale(15), marginHorizontal: moderateScale(5) }}>{'+0971528132016'}</Text>
