                ...
                <View style={{ height: moderateScale(55), }}>
                    <ScrollView horizontal={true} contentContainerStyle={{ height: moderateScale(35), }} showsHorizontalScrollIndicator={false}>
                        <View style={{
                            ...
                            }, this.state.selected === 1 ? { backgroundColor: theme.colors.secondary, } : { backgroundColor: theme.colors.gray05, }]}>
                                <TouchableOpacity onPress={() => { this.setState({ selected: 1, type: '0' }); this.fetchRequests() }}>
                                    <Text style={[{ color: theme.colors.primary, fontSize: moderateScale(13), padding: moderateScale(5), fontWeight: '600', textAlign: 'center', paddingHorizontal: moderateScale(10), }, this.state.selected === 1 ? {} : { color: theme.colors.secondary }]}>{translate('Online Talk')}</Text>
                                </TouchableOpacity>
                            </View>
                            ...
                            <View style={[{
                                justifyContent: 'center', alignContent: 'center', alignItems: 'center', borderRadius: moderateScale(0), marginHorizontal: moderateScale(4),
                            }, this.state.selected === 2 ? { backgroundColor: theme.colors.secondary, } : { backgroundColor: theme.colors.gray05, }]}>
                                <TouchableOpacity onPress={() => { this.setState({ selected: 2, type: '1' }); this.fetchRequests() }}>
                                    <Text style={[{ color: theme.colors.primary, fontSize: moderateScale(13), padding: moderateScale(5), fontWeight: '600', textAlign: 'center', paddingHorizontal: moderateScale(10), }, this.state.selected === 2 ? {} : { color: theme.colors.secondary }]}>{translate('Ads Requests')}</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={{ height: '100%', width: 1, backgroundColor: 'white' }} />
                            ...
                            <View style={[{
                                justifyContent: 'center', alignContent: 'center', alignItems: 'center', borderRadius: moderateScale(0), marginHorizontal: moderateScale(4),
                            }, this.state.selected === 3 ? { backgroundColor: theme.colors.secondary, } : { backgroundColor: theme.colors.gray05, }]}>
                                <TouchableOpacity onPress={() => { this.setState({ selected: 3, type: '2' }); this.fetchRequests() }}>
                                    <Text style={[{ color: theme.colors.primary, fontSize: moderateScale(13), padding: moderateScale(5), fontWeight: '600', textAlign: 'center', paddingHorizontal: moderateScale(10), }, this.state.selected === 3 ? {} : { color: theme.colors.secondary }]}>{translate('Invitation Requests')}</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={[{
                                justifyContent: 'center', alignContent: 'center', alignItems: 'center', borderRadius: moderateScale(0), marginHorizontal: moderateScale(4),
                            }, this.state.selected === 4 ? { backgroundColor: theme.colors.secondary, } : { backgroundColor: theme.colors.gray05, }]}>
                                <TouchableOpacity onPress={() => { this.setState({ selected: 4, type: '3' }); this.fetchRequests() }}>
                                    <Text style={[{ color: theme.colors.primary, fontSize: moderateScale(13), padding: moderateScale(5), fontWeight: '600', textAlign: 'center', paddingHorizontal: moderateScale(10), }, this.state.selected === 4 ? {} : { color: theme.colors.secondary }]}>{translate('Book Hour')}</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={[{
                                justifyContent: 'center', alignContent: 'center', alignItems: 'center', borderRadius: moderateScale(0), marginHorizontal: moderateScale(4),
                            }, this.state.selected === 5 ? { backgroundColor: theme.colors.secondary, } : { backgroundColor: theme.colors.gray05, }]}>
                                <TouchableOpacity onPress={() => { this.setState({ selected: 5, type: '4' }); this.fetchRequests() }}>
                                    <Text style={[{ color: theme.colors.primary, fontSize: moderateScale(13), padding: moderateScale(5), fontWeight: '600', textAlign: 'center', paddingHorizontal: moderateScale(10), }, this.state.selected === 5 ? {} : { color: theme.colors.secondary }]}>{translate('Gift Video')}</Text>
                                </TouchableOpacity>
                            </View>
                        </View>
                    </ScrollView>
