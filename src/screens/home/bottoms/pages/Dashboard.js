            ...
            <Block>
                ...
                <View style={{ flexDirection: 'row', marginTop: moderateScale(0), width: '100%', padding: moderateScale(20) }}>
                    <View style={{
                        ...
                        <TouchableOpacity style={{ width: '100%', height: '100%' }} onPress={() => { this.props.navigation.navigate('Requests') }}>
                            <View style={{ flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
                                ...
                                <View style={{ flexDirection: 'column' }}>
                                    ...
                                    <Text style={[{
                                        fontWeight: '500', textAlign: 'center',
                                        color: theme.colors.secondary, fontSize: moderateScale(10), marginHorizontal: moderateScale(0), marginVertical: moderateScale(10), width: '100%',
                                    }]}>{'check requests'}</Text>
                                </View>
                            </View>
                        </TouchableOpacity>
                ...
                <View style={{ flexDirection: 'row', marginTop: moderateScale(0), width: '100%', padding: moderateScale(20), marginTop: moderateScale(-40) }}>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity style={{ width: '100%', height: '100%' }} onPress={() => { this.props.navigation.navigate('Pricing') }}>
                            <View style={{ flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: moderateScale(0), width: '100%', padding: moderateScale(20), marginTop: moderateScale(-40) }}>
                    ...
                    <View style={{
                        ...
                        <TouchableOpacity style={{ width: '100%', height: '100%' }} onPress={() => { this.props.navigation.navigate('Money') }}>
                            <View style={{ flexDirection: 'column', justifyContent: 'center', flex: 1 }}>
