    ...
    render() {
        ...
        return (
            <View style={{
                ...
                <View style={{
                    width: '100%', backgroundColor: theme.colors.white, shadowColor: "#000",
                    shadowOffset: {
                        width: 0,
                        height: 1,
                    },
                ...
                <View style={[{
                    ...
                    alignItems: 'center', paddingEnd: moderateScale(10),
                }]}>
                    <View style={{
                        flex: 1.8
                    }}>
                        ...
                        <TouchableOpacity
                            ...
                            {this.props.search &&
                                <Image resizeMode="contain" source={require('app/assets/search.png')} style={{
                                    height: scale(25), width: scale(25), tintColor: theme.colors.secondary
                                }} />}
                        </TouchableOpacity>
