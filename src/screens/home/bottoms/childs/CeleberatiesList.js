        ...
        return (
            <View style={{
                ...
                <FlatList
                    ...
                    contentContainerStyle={{ height: moderateScale(32), }}
                ...
                <FlatList
                    ...
                    contentContainerStyle={{
                        paddingHorizontal: moderateScale(10), marginTop: moderateScale(20)
                    }}
                    ...
                    renderItem={({ item, index, column }) => (
                        ...
                        <TouchableOpacity
                            ...
                            onPress={() => { }} style={[{
                                flex: 1 / 2, flexDirection: 'row', marginBottom: moderateScale(10), marginHorizontal: moderateScale(5), borderRadius: moderateScale(10)
                            }]}>
                            <View style={{ width: '100%', }}>
                                <Image source={{ uri: (BASE_API_URL_IMAEG_ORIGINAL + (item.images[0] ? item.images[0].url : '')) }} resizeMode={'cover'} style={{
                                    height: moderateScale(220), width: '100%', borderRadius: moderateScale(0), marginTop: moderateScale(0), borderRadius: moderateScale(10), zIndex: 2,
                                }} />
