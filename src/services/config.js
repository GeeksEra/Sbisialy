...
export const BASE_API_URL_IMAEG_ORIGINAL = API_URL[currentEnv] + '/uploads/original/';
...
export const MARCHENT_KEY_TEST = 'test_$2y$10$dRat0iZ.uvCm.SZVEyta2.ym1.Da9vz7oI5jFjkrsLMszwUe6QL22';
export const MARCHENT_KEY_LIVE = 'live_$2y$10$tsEZX410Pm7p893ieoBlv.Q8qiG-8kUmAT0qOjZ0SnjWHXRIzbTHS';

export const FOLOOSI_URL_TEST = 'https://foloosi.com/api/v1/api/initialize-setup';
export const FOLOOSI_URL_LIVE = 'https://foloosi.com/api/v1/api/initialize-setup';
